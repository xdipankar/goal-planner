...
<title> My Task | <?php echo $dm_name ?></title>
<!-- ..........Start........ -->
 <div class="row">

  <div class="col-xl-3 col-lg-6 col-md-6 col-12">
    <div class="card bg-success bg-lighten-4  pull-up">
        ...
        <div class="card-body py-0">
          ...
          <div class="media-body success text-left">
              <h3 class="font-large-1 success mb-0">
                <?php 
                  $nRows = $pdo->query("select count(*) from task where userid='$dm_id' and category='1' and status='PENDING'")->fetchColumn(); 
                  echo $nRows
                  ?>
              </h3>
  ...
  <div class="col-xl-3 col-lg-6 col-md-6 col-12">
    <div class="card bg-info bg-lighten-3  pull-up">
      <div class="card-content">
        <div class="card-body py-0">
          <div class="media">
          <div class="media-body info text-left">
              <h3 class="font-large-1 info mb-0 ">
                <?php 
                  $nRows = $pdo->query("select count(*) from task where userid='$dm_id' and category='2' and status='PENDING'")->fetchColumn(); 
                  echo $nRows
                  ?>
                     </h3>
        ...
        <div class="card-body py-0">
          ...
          <div class="media-body primary text-left">
              <h3 class="font-large-1 primary mb-0">
                <?php 
                  $nRows = $pdo->query("select count(*) from task where userid='$dm_id' and category='3' and status='PENDING'")->fetchColumn(); 
                  echo $nRows
                  ?>
              </h3>
  ...
  <div class="col-xl-3 col-lg-6 col-md-6 col-12">
    <div class="card bg-danger bg-lighten-3  pull-up">
      <div class="card-content">
        <div class="card-body py-0">
          <div class="media">
          <div class="media-body danger text-left">
              <h3 class="font-large-1 danger mb-0">
                <?php 
                  $nRows = $pdo->query("select count(*) from task where userid='$dm_id' and category='4' and status='PENDING'")->fetchColumn(); 
                  echo $nRows
                  ?>
              </h3>
              <span>Not Important Not Urgent</span>
            </div>
            <div class="media-right danger text-right">
    ...
    <div class="card">
      <div class="card-body">
        <div class="modal-header">
          <h3 class="text-primary"><i class="ft-target text-danger mr-2"></i>My Pending Tasks</h3>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header gradient-purple-bliss">
          ...
          <h4 class="modal-title text-white"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add </span> My Day Task </h4>
        ...
        <form method="post" action="#" id="cat_form">
          <div class="modal-body with-padding">
                ...
                <div class="form-group">
                    <div class="controls">
                      <label for="amount" class="col-form-label">Task Name</label>
                      <input type="text" name="name" id="name" class="form-control mb-2" placeholder="Meeting with Company Head" required>
                    </div>
                  </div>
                  <div class="form-group">
                        <label for="category" class="col-form-label">Task Category </label>
                        <div class="">
...
<script>
  ...
  $(document).on('submit','#cat_form',function(){
      ...
      // $('#logerror').html('<img src="ajax.gif" align="absmiddle"> Please wait...');  
        ...
        { Swal.fire({title:"Success",text:"task Saved Successfully",type:"success",confirmButtonClass:"btn btn-success",showConfirmButton:true});
  ...
  function readProducts(){
    $('#load-result').load('action/task.r.php'); 
  }
</script>
<!-- ..........End........ -->
