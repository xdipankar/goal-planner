...
<title> My Projects | <?php echo $dm_name ?></title>
<!-- ..........Start........ -->
 <div class="row">
        ...
        <div class="card-body py-0">
          <div class="media">
            ...
            <div class="media-right primary text-right">
              <i class="icon-target primary font-large-1"></i>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="media">
            <div class="media-body warning text-left">
              <h3 class="font-large-1 warning mb-0">
                <?php 
                  $nRows = $pdo->query("select count(*) from pgoal where pstatus='PENDING' and userid='$dm_id'")->fetchColumn(); 
                  echo $nRows
                  ?>
              </h3>
              <span>Pending</span>
            ...
            <div class="media-right warning text-right">
              <i class="ft-info warning font-large-1"></i>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="media">
            <div class="media-body success text-left">
              <h3 class="font-large-1 success mb-0">
                <?php 
                  $nRows = $pdo->query("select count(*) from pgoal where pstatus='COMPLETED' and userid='$dm_id'")->fetchColumn(); 
                  echo $nRows
                  ?>
              </h3>
              <span>Completed</span>
    ...
    <div class="card">
      <div class="card-body">
        <div class="modal-header">
          <h3 class="text-primary"><i class="icon-cup text-danger mr-2"></i>Projects</h3>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header gradient-purple-bliss">
          ...
          <h4 class="modal-title text-white"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add </span> My Projects </h4>
        ...
        <form method="post" action="#" id="cat_form">
          <div class="modal-body with-padding">
                ...
                <div class="form-group">
                    <div class="controls">
                      <label for="amount" class="col-form-label">Project Name</label>
                ...
                <div class="form-group" id="goalstatus">
                        <label for="txtLastNameBilling" class="col-form-label">Status</label>
                        <div class="">
...
if($('input[name="pstatus"]').val() < 100);
{

$("#pstatus option:selected").val('PENDING')
