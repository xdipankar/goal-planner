$(document).ready(function() {
  ...
  if ($("body.layout-dark.layout-transparent").length > 0) {
    ...
    $("#ll-switch").on("click", function() {
      $(".sidebar-background").css("background-image","img/sidebar-bg/01.jpg");
    });
  }
  ...
  $(".cz-bg-color span").on("click", function() {
    ...
    if (bgColor == "white") {
      ...
      if ($(".logo-img img").attr("src") =="img/logo-dark.png") {
        $(".logo-img img").attr("src", "img/logo.png");
      }
    }
  });
  ...
  $("#dl-switch").on("click", function() {
    ...
    if ($("body").hasClass("layout-transparent")) {
      ...
      $(".sidebar-background").css("background-image","url(../../img/sidebar-bg/01.jpg)");
      $(".navbar").removeAttr('style');
      mainMenu.attr("data-background-color", "black");
    } else {
      $(".navbar").removeAttr('style');
